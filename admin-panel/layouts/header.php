...
session_start();
define("ADMINURL", "http://localhost/finalHotel/admin-panel/");
...
<body>
    <div id="wrapper">
        <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#"><img src="../../img/PE Logo.png" alt="" srcset=""></a>
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <img src="../../css/bootstrap.min.css" alt="" srcset="">
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    ?>
                        <ul class="navbar-nav side-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ADMINURL; ?>/user-admins/show-users.php" style="margin-left: 20px;">Users</a>
                            </li>
                            <li class="nav-item">
